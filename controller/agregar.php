...
if(!empty($_POST)){
    ...
    if($codigo != $_SESSION['id_empleado']){
        ...
        if($filas > 0){
            ...
            $consulta = "INSERT INTO estudiantes(codigo, nombres, dui, direccion, telefono, puesto, estado,tipo,contrasenia,disponible) VALUES('$codigo','$nombres', '$dui', '$direccion', '$telefono', '$puesto', '1', '$tipo', '$pass', '1')";
            ...
            $consulta = "UPDATE estudiantes SET disponible='0' WHERE codigo='$codigo'";
            $conexion ->query($consulta);

...
<div class="container ">
  <div>
    <h1 class="h4 mb-4 mt-5">Lista de Estudiantes Matriculados</h1>
			...
			<table class="table table-striped table-hover" id="user">
				...
				$filter = 1;
					if($filter){
						...
						$sql = mysqli_query($conexion, "SELECT * FROM estudiantes WHERE estado='$filter' ORDER BY codigo ASC");
					}else{

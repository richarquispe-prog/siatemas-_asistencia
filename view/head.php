...
<body style="background-color: #e4efe7;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark d-flex justify-content-between">
        <div class = "d-flex bd-highlight mx-2 ">
            <a class="btn btn-light d-inline p-2 d-grip" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Menu</a>
        </div>
